...
namespace Syringe.Tests.Unit.Web
{
    ...
    public class TestControllerTests
    {
        ...
        public void Setup()
        {
            ...
            ITestServiceMock.Setup(x => x.GetTest(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<Guid>()));
            ITestServiceMock.Setup(x => x.DeleteTest(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string>()));
        ...
        public void Edit_should_return_correct_view_and_model()
        {
            ...
            // then
            ITestServiceMock.Verify(x => x.GetTest(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<Guid>()), Times.Once);
        ...
        public void Delete_should_return_correct_redirection_to_view()
        {
            ...
            // then
            ITestServiceMock.Verify(x => x.DeleteTest(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once);
            Assert.AreEqual("View", redirectToRouteResult.RouteValues["action"]);
        }
